...

{
  ...
  echo "    <script src=\"http://localhost:81/ssr/common_functions.js\"></script>"
  echo "    <script src=\"http://localhost:81/ssr/result_table.js\"></script>"
  echo "    <script src=\"http://localhost:81/ssr/chart.js\"></script>"
  echo "  </body>"
  echo "</html>"
} >> scraping.php
